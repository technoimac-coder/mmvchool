...
if ($databaseReady) {
    try {
        $requiredTables = ['users', 'vehicles', 'vehicle_bookings', 'meeting_rooms', 'room_bookings', 'line_accounts', 'line_link_codes', 'leave_requests', 'official_duty_requests', 'substitute_teachings', 'repair_tickets', 'notifications', 'approval_pipelines', 'system_settings'];
