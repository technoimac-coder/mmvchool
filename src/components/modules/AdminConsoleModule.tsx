  ...
  const initialPipelines: WorkflowPipeline[] = [
    ...
    },
    {
      ...
      steps: [
        ...
        { stepNumber: 2, stepName: 'รองผู้อำนวยการฝ่ายทั่วไป ตรวจสอบ & อนุมัติขั้นต้น', assignedUserId: 'MMV03', description: 'รอง ผอ. กลุ่มบริหารทั่วไป ตรวจสอบความถูกต้องและเสนอความเห็น/อนุมัติขั้นต้น' },
    ...
    },
    {
      ...
      color: 'violet',
      steps: [
        { stepNumber: 1, stepName: 'ผู้ตรวจสอบเอกสารคนที่ 1', assignedUserId: 'MMV02', description: 'ได้รับสิทธิ์ดูรายการเอกสารของครูทุกคนเพื่อตรวจสอบเวลาส่ง' },
        { stepNumber: 2, stepName: 'ผู้ตรวจสอบเอกสารคนที่ 2', assignedUserId: '', description: 'สิทธิ์เสริม (ไม่ใช่ลำดับการอนุมัติ)' },
        { stepNumber: 3, stepName: 'ผู้ตรวจสอบเอกสารคนที่ 3', assignedUserId: '', description: 'สิทธิ์เสริม (ไม่ใช่ลำดับการอนุมัติ)' },
        { stepNumber: 4, stepName: 'ผู้ตรวจสอบเอกสารคนที่ 4', assignedUserId: '', description: 'สิทธิ์เสริม (ไม่ใช่ลำดับการอนุมัติ)' },
        { stepNumber: 5, stepName: 'ผู้ตรวจสอบเอกสารคนที่ 5', assignedUserId: '', description: 'สิทธิ์เสริม (ไม่ใช่ลำดับการอนุมัติ)' }
      ]
    }
  ];
