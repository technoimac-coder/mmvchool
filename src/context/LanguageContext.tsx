...
const translations: Record<string, string> = {
  ...
  'ผู้ตรวจสอบเอกสาร': 'Document Review',
  'ตรวจสอบการส่งเอกสาร': 'Document Submission Review',
  'เรียงตามเวลาส่ง: รายการแรกอยู่บนสุด': 'Sorted by submission time: earliest first',
  'วัน–เวลาที่ส่ง': 'Submitted Date & Time',
  'ครูผู้ส่ง': 'Submitted By',
